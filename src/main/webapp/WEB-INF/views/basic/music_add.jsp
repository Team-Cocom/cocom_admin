...
<body>
    <main>
        ...
        <c:if test="${music_no != null}">
            <div class="music_mod_wrap">
                <table class="music_mod_area">
                    <tbody>
                        <tr>
                            <td>커버이미지</td>
                            <td>
                                ...
                                <button id="cover_img_mod_save"
                                    onclick="document.getElementById('music_cover_mod_img').click()">커버
                                    이미지 변경</button>   
                            <td class="cover_img_mod_area">
                                <c:if test="${list.mu_img_file != ''}">
                                <div class="music_img_mod" data-name="${list.mu_img_file}">
                                    <img src="/images/music_cover/${list.mu_img_file}" >
                        ...
                        <tr>
                            <td>
                                ...
                                <button id="music_file_save_mod"
                                    onclick="document.getElementById('music_file_mod').click()">노래
                                    변경</button>
                            ...
                            <td>가사 변경</td>
                            <td>
                                <textarea id="mu_lylic_mod" cols="30" rows="10">${list.mu_lyrics}</textarea>
                            </td>
                            <td>노래 설명 변경</td>
                            <td>
                                <textarea id="mu_explain_mod" cols="30" rows="10" >${list.mu_explain_txt}</textarea>
                            </td>
                        </tr>
                        </tr>
                    </tbody>
